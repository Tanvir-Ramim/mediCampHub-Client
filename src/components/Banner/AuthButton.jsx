        ...
        <div className=" cursor-pointer md:ml-8 md:mt-0 mt-4 bg-[#B354A6] text-white text-xl rounded-3xl hover:bg-[#7c4e77] ">
             {
                user? <div className="flex gap-3 items-center py-2 px-6 relative group">
                     ...
                     <button onClick={handleLogOut} className="bg-[#11192BA8] text-white py-2 z-10 px-4 rounded absolute top-10 right-12 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                                    LogOut
                 </button>
                </div> 
                :
